...
option(${PROJECT_NAME}_ENABLE_UBSAN "Enable Undefined Behavior Sanitizer to detect UB at runtime." OFF)
if(${PROJECT_NAME}_ENABLE_UBSAN)
    add_compile_options(-fsanitize=undefined)
    add_link_options(-fsanitize=undefined)
endif()

option(${PROJECT_NAME}_ENABLE_COVERAGE "Enable coverage instrumentation (gcov / llvm-cov)." OFF)
